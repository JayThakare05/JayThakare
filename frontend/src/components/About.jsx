...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="min-h-screen flex items-center bg-black relative py-32 overflow-hidden"
    >
      {/* Cinematic Depth: Large background text */}
      <div className="absolute top-1/2 left-0 -translate-y-1/2 -rotate-90 select-none pointer-events-none opacity-[0.02] transform origin-left">
        <span className="text-[20rem] font-display font-black text-white whitespace-nowrap">
          WHO I AM
        </span>
      </div>

      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-24 px-6 md:px-12 items-center relative z-10">
        ...
        >
          <motion.h2
            ...
            className="text-white text-3xl font-display font-bold tracking-widest border-b border-white/10 pb-2 inline-block mb-12"
          >
            ABOUT ME
          </motion.h2>
          ...
          <div className="space-y-8">
            <motion.p
              variants={itemVariants}
              className="text-white text-2xl md:text-3xl font-display font-medium leading-tight"
            >
            ...
            <motion.p variants={itemVariants} className="text-silver-muted leading-relaxed text-lg">
          ...
          <motion.div
            variants={itemVariants}
            className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16 pt-8 border-t border-white/5"
          >
        ...
        >
          ...
          <div className="absolute top-0 left-0 w-12 h-12 border-l border-t border-white/20 -mt-3 -ml-3 group-hover:border-white/50 transition-all duration-500"></div>
          <div className="absolute bottom-0 right-0 w-12 h-12 border-r border-b border-white/20 -mb-3 -mr-3 group-hover:border-white/50 transition-all duration-500"></div>
          ...
          <div className="absolute -bottom-12 -left-12 opacity-10 pointer-events-none select-none">
            <p className="text-[8rem] font-display font-black text-white leading-none">J.T</p>
          </div>
        </motion.div>
